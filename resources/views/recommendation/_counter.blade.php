...
<div class="row w-100 d-flex flex-column p-5">
    ...
    <div class="row 100">
        ...
        <div class="col-xl-3 col-md-6 mb-4 align-self-start">
            <a href="{{ route('recommendation.all') }}">
                <div class="card border-left-secondary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1"><h5>All Courses</h5></div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $countAllBooks }}</div>
                            </div>
                            <div class="col-auto">
